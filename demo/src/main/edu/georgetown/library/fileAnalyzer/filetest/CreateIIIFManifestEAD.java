 ...
 *
 */
class CreateIIIFManifestEAD extends DefaultFileTest {
        ...
        private IIIFManifestEAD manifest;
        ...
        public InitializationStatus init() {
                ...
                if (!manFile.canWrite()) {
                        ...
                        manifest = new IIIFManifestEAD(dt.getRoot(), this.getProperty(IIIFROOT).toString(), manFile);                        
                }
                return super.init();
        }
